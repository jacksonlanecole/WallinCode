...
def setup_target_structure(filename, run_number, n1_particles,
        n2_particles):
...
def get_runs_scores_and_wipe_unpack(zipped):
    ...
    get_runs_scores_and_wipe. This was the only implementation to be
    able to call a multi-arg function with map_async using only one
    arg.
    """
